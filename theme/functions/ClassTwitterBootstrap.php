...
$ClassTwitterBootstrap = new ClassTwitterBootstrap();

class MenuBootstrap extends Walker_Nav_Menu
{
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 )
	{
		...
		//$item_output .= ($depth == 0 && $args->has_children) ? ' <i class="icon-chevron-down"></i></a>' : '</a>';
